---
name: pr-cycle-backend-wordpress
description: |
  ...
  Examples:
  - `/dev-workflow:pr-cycle-backend-wordpress 42`
  - `/dev-workflow:pr-cycle-backend-wordpress 42 MPP-221`
  - `/dev-workflow:pr-cycle-backend-wordpress 42 MPP-221 "MPP-150 Memories list view"`
user-invocable: true
