...
description: |
  ...
  Examples:
  - `/dev-workflow:pr-cycle-backend-rails 42`
  - `/dev-workflow:pr-cycle-backend-rails 42 MPP-221`
  - `/dev-workflow:pr-cycle-backend-rails 42 MPP-221 "MPP-150 Memories list view"`
user-invocable: true
