---
name: pr-cycle-frontend-shopify
description: |
  ...
  Examples:
  - `/dev-workflow:pr-cycle-frontend-shopify 42`
  - `/dev-workflow:pr-cycle-frontend-shopify 42 MPP-221`
  - `/dev-workflow:pr-cycle-frontend-shopify 42 MPP-221 "MPP-150 Memories list view"`
user-invocable: true
